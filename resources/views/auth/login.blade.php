...
<div class="container">
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-5 pt-1 pb-5" style="height: auto;">
            ...
            <div>
                <div class="card-header text-center mb-1" style="border:1px solid #fff;background-color: transparent;">
                ...
                <div class="card-body pt-0">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="login_id"
                                class="col-md-12 col-form-label text-md-left"><b>{{ __('LOGIN ID') }}</b></label>

                            <div class="col-md-12">
                                <input id="login_id" autocomplete="new-password" type="text"
                        ...
                        <div class="form-group row">
                            <label for="password"
                                class="col-md-12 col-form-label text-md-left"><b>{{ __('PASSWORD') }}</b></label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12 text-left">
                               <p>Don't have account?  <a href="{{ route('register') }}"><b>{{ __('Register') }}</b></a></p>
                            </div>
                        </div>
                    </form>
                </div>
