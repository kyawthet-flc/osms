        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{($subProduct->quantity_avaiable - $subProduct->quantity_left) }}*{{ $subProduct->price_sold }}
                    </td>
                    <td>{{ ($subProduct->quantity_avaiable - $subProduct->quantity_left) * $subProduct->price_sold }}
                    </td>
                    <td>{{ $subProduct->orderDetails->sum('sub_total_price') - ($subProduct->price_original * $subProduct->quantity_avaiable) }}
                    </td>
                    @php
