    ...
    <div class="row mt-2">
        <div class="col-md-12">
            ...
            <x-utils.card :attrs="['title' => 'Creating New Dispensing Modalities']">
                <x-forms.form-tag :attrs="['id' => 'admin-user-form', 'class' => 'admin-user-form', 'method' => 'post', 'action' => route('product_setup.modalities.store') ]">
                    <div class="row">
                        <div class="col-md-6">
    ...
    <script>
        $(document).ready(function() {
            $('.btn_edit').on('click', function() {
                ...
                $.ajax({
                    type:'json',
                    url:'/productSetup/modalities/get_modalities',
                    method:'GET',
                    data:{id:id},
            ...
            $('.btn_delete').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href="/productSetup/modalities/delete/"+id;
                    }
                })
            });
        })
