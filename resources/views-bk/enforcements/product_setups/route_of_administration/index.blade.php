...
@section('content')
    <div class="row mt-2">
        <div class="col-md-12">
            ...
            <x-utils.card :attrs="['title' => 'Creating New Dispensing Modalities']">
                <x-forms.form-tag :attrs="['id' => 'admin-user-form', 'class' => 'admin-user-form', 'method' => 'post', 'action' => route('product_setup.route_administration.store') ]">
                    <div class="row">
                        <div class="col-md-6">
    ...
    <x-utils.card :attrs="['title' => 'Route of Administration']">
    ...
    <script>
        $(document).ready(function() {
            $('.btn_edit').on('click', function() {
                ...
                $.ajax({
                    type:'json',
                    url:'/productSetup/route_administration/get_route_administration',
                    method:'GET',
                    data:{id:id},
            ...
            $('.btn_delete').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href="/productSetup/route_administration/delete/"+id;
                    }
                })
            });
        })
