...
<div class="row">
    <div class="col-md-12">
    <a href="{{ route('account_setup.roles.index') }}" class="btn btn-primary float-left mb-3">Back</a>
    </div>
</div>


<x-utils.card :attrs="['title' => 'Role Permissions for ' . $role->name ]">
   <div class="row">
      <x-forms.form-tag :attrs="['id' => 'role-permission-form', 'class' => 'role-permission-form', 'method' => 'post', 'action' => route('account_setup.roles.permissions.store', $role) ]">
