@extends('layouts.app')
@section('title') DLMC Application Report @endsection

@section('content')

<x-utils.card :attrs="['title' => 'DLMC Application Report']">

  @include('enforcements.tasks.reports.dlmc.application-search-form')
  ...
  <div class="table-responsive">
    <table class="table table-bordered table-bordered">     
     ...
     <tbody>
      @php
        $lists->load(['dlmcActionRecord', 'dlmcDrugsToProduces']);
