<form action="{{ url()->current() }}">
		<div class="row">
			...
			<div class="col-md-4">
				<input type="text" class="form-control mt-2" value="{{ request('company_name') }}" name="company_name" placeholder="Company Name" />
			</div>

			<div class="col-md-4">
				<input type="text" class="form-control mt-2" value="{{ request('generic_name') }}" name="generic_name" placeholder="Generic Name" />
			</div><div class="col-md-4">
				<input type="text" class="form-control mt-2" value="{{ request('brand_name') }}" name="brand_name" placeholder="Brand Name" />
			</div>
