@extends('layouts.app')
@section('title') DIAC Application Report @endsection

@section('content')

<x-utils.card :attrs="['title' => 'DIAC Application Report']">

  @include('enforcements.tasks.reports.diac.application-search-form')
