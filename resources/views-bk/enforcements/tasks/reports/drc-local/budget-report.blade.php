@extends('layouts.app')
@section('title') DRC(local) Budget Report @endsection

@section('content')

    <x-utils.card :attrs="['title' => 'DRC(local) Budget Report']">

        @include('enforcements.tasks.reports.drc.budget-search-form')
