@extends('layouts.app')
@section('title') DRC(local) Application Report @endsection

@section('content')

    <x-utils.card :attrs="['title' => 'DRC(local) Application Report']">

        @include('enforcements.tasks.reports.drc.application-search-form')
