<form action="{{ url()->current() }}">
		<div class="row">
			...
			<div class="col-md-4">
				<input type="text" class="form-control mt-2" value="{{ request('importer_name') }}" name="importer_name" placeholder="Importer Name" />
			</div>

			<div class="col-md-4">
				<input type="text" class="form-control mt-2" value="{{ request('drug_name') }}" name="drug_name" placeholder="Drug Name" />
			</div>
			<div class="col-md-4">
