<x-forms.form-tag :attrs="['id' => 'lab-result-request-form', 'class' => 'lab-result-request-form', 'method' => 'GET', 'action' => route('tasks.drc_local.lab_send_result_request_form',['drcApplication' => $drcApplication]) ]">
<div class="row">  
      <div class="col-md-12">
