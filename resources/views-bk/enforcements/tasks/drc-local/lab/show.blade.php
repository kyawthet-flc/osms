...
<x-utils.card :attrs="['title' =>  'DRC Lab Detail']">
    ...
    @include('enforcements.tasks.drc-local.lab.detail._main')
{{--    @include('enforcements.tasks.drc-local.lab.detail._lab-bioessay-form',['labTitle' => 'Bioessay Form'])--}}
{{--    @include('enforcements.tasks.drc-local.lab.detail._lab-contamination-form',['labTitle' => 'Contamination Form'])--}}
{{--    @include('enforcements.tasks.drc-local.lab.detail._lab-disinfectant-form',['labTitle' => 'Disinfectant Form'])-- }}--}}
