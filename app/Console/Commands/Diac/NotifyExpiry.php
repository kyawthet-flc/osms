...
use App\Notifications\Diac\NotifyExpiry as NotifyExpiryNotifcation;
...
class NotifyExpiry extends Command
{
     ...
     * @var string
     */
    protected $signature = 'diac:notify-expiry';
    ...
    public function handle()
    {
        ...
        foreach ($applicationTypes as $key => $applicationType) {
            ...
            $lists = $this->diacApplication->whereDate('expire_date', '=', date('Y-m-d'))->whereApplicationStatus('approved')->get();
