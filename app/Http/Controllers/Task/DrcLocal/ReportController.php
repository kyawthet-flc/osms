...
use App\Reports\DrcLocal\ApplicationReport as ExportApplicationReport;
use App\Reports\DrcLocal\BudgetReport as ExportBudgetReport;
...
class ReportController extends Controller
{
    ...
    public function applicationReport()
    {
        ...
        if( request('action') === 'report' ) {
            ...
            return $this->viewPath('enforcements.tasks.reports.drc-local.application-report');
        }
    }
    ...
    public function budgetReport()
    {
        ...
        if( request('action') === 'report' ) {
            return Excel::download(new \App\Reports\Drc\BudgetReport($lists), 'DRC(import)-Budget-reporting.xlsx');
        } else {
            $this->data = array('lists' => $lists);
            return $this->viewPath('enforcements.tasks.reports.drc-local.budget-report');
        }
